                                ...
                                <h2 class="pageheader-title">Blood Bank Management System </h2><br>
                                    ...
                                    if($conn->connect_error){
                                        ...
                                        die("Connection Failed : ". $conn->connect_error);
                                                                ...
                                                                $sql="insert into donors(Name,Gender,Age,Address,Contactno,Bloodgroup) values ('$name','$gender','$age','$address','$phone','$type')";
                                                                    
                                                                $result=mysqli_query($conn,$sql);
                                                                
                                                            
                                                                echo '<h1 class="display-6">';
                                                                echo "$name, your registration is successfull.</h1>";
                                                                echo '<br>
                                                                <a href="index2.php"><button type="button" class="btn btn-primary">Return to dashboard</button></a>
                                                                ';
                                                            mysqli_close($conn);}
                                    ?>
