                            ...
                            <div class="page-header">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="donate" name="donate" placeholder="Name">
                                    ...
                                    $Units = "";
                                                            ...
                                                            if(!is_null($row['Name']))
                                                                {   echo "<h4>";
                                                                    echo $row['Name']." found with Blood group ".$row['Bloodgroup'];
                                                                    
                                                                    $type=$row['Bloodgroup'];
                                                                    
                                                                    echo "</h4>";
                                                                    echo '<form action="bloodunits.php" method="post"><div class="form-group">
                                                                    <label for="exampleInputEmail1">Enter blood to donate </label>
                                                                    ...
                                                                    <input type="text" class="form-control" id="units" name="units" placeholder="unit">
                                                            ...
                                                            if($a==0)
                                                            echo "<h4>User not found. Please register as new donor to donate.</h4>";
                                                        }
