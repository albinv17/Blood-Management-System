                                ...
                                <h3>Request</h3>
                                    ...
                                    if($conn->connect_error){
                                        ...
                                        die("Connection Failed : ". $conn->connect_error);
                                                                    ...
                                                                    $sql="insert into requestdetails(Name,Stock,Bloodtype,Address,Phone) values ('$name','$Units','$type','$address','$phone')";
                                                                    
                                                                $result=mysqli_query($conn,$sql);
                                                                $sql2="select Stock from stock where Bloodtype='$type'";
                                                                ...
                                                                $oldunits=$oldunits-$Units;
                                                                
                                                                $sql2="update stock set Stock='$oldunits' where Bloodtype='$type'";
                                                                $result2=mysqli_query($conn,$sql2);
                                                                echo '<h1 class="display-6">';
                                                                echo "$name, your request for $type blood $Units units is successfull.</h1>";
                                                                echo '<h1 class="display-6">Blood Bank balance updated</h1><br>
